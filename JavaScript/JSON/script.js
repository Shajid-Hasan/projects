...
const loadPost = () => {
  ...
  fetch(url) //promise of response
    .then((res) => res.json()) //through to function then call res.json and promise json data

    .then((json) => {
        console.log(json);
        displayPost(json);
    }); //json data send to function as a parameter and call display post and send arraow of object
};
